$(document).ready(function(){
    $('.carousel__inner').slick({
      ...
      speed: 800,
      fade: true,
      prevArrow: '<button type="button" class="slick-prev"><img src="https://korobskix.ru/wp-content/themes/korobskix/assets/img/pulse-img/icon/chevron_left_solid_980.jpg"></button>',
      nextArrow: '<button type="button" class="slick-next"><img src="https://korobskix.ru/wp-content/themes/korobskix/assets/img/pulse-img/icon/chevron_right_solid_982.jpg"></button>',
      responsive: [
        {
          breakpoint: 992,
          settings: {
